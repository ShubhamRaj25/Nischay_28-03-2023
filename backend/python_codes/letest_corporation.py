...
def corporation_digitization(pdf_path,pdf_password):
    ...
    if len(result)==0:
        ...
        master_table2.to_csv("{}/{}_Digitized.csv".format(file_name),index=False)        
        result.to_csv("{}/{}_LogicalChecks.csv".format(file_name),index=False)
        return
    ...
    final['bank_name'] = 'Corporation_bank'
    ...
    # exporting the file
    final.to_csv(r'/Users/hardikbhardwaj/Desktop/digitised/{}_b.csv'.format(file_name), index=False)
    return r'/Users/hardikbhardwaj/Desktop/digitised/{}_b.csv'.format(file_name)



# corporation_digitization(r'D:\bank\765606_4_01-01-2020 to 24-02-2020.pdf',"")
