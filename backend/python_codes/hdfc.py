...
def hdfc_digitization(pdf_path):
    ...
    s='(\-*\d+\.\d{2})'
    master_table2["Balance"]=master_table2["Balance"].apply(lambda x: findall(s,x)[0])
    ...
    # final.to_csv(r'/Users/shubhamraj/Desktop/csv_files/{}_b.csv'.format(file_name), index=False)
    print("Here are the files INT THE LOCATION")
    print(file_name)
    file_name = file_name.split('\\')[1]
    print(r'/Users/shubhamraj/Desktop/csv_files/{}_b.csv'.format(file_name))
    print(r'/Users/shubhamraj/Desktop/csv_files/{}_b.csv'.format(file_name))
    final.to_csv(r'/Users/shubhamraj/Desktop/csv_files/{}_b.csv'.format(file_name), index=False)

   
    return r'/Users/shubhamraj/Desktop/csv_files/{}_b.csv'.format(file_name)


# try :
#    hdfc_digitization(r"/Users/hardikbhardwaj/Desktop/Bank statement_2121.pdf")
# #    hdfc_digitization(pdf_path)
