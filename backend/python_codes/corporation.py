...
def corporation_digitization(pdf_path,pdf_password):
    ...
    try:
        ...
        other_details_list =  tabula.read_pdf(pdf_path, pages=1,password=passcode, area=[0,0,576,775], pandas_options = col2str)
    except:
    ...
    # exporting the file
    final.to_csv("/Users/hardikbhardwaj/Desktop/digitised/{}_b.csv".format(out_path,file_name, account_no, last_trans_date),index=False)
    return r("/Users/hardikbhardwaj/Desktop/digitised/{}_b.csv".format(out_path,file_name, account_no, last_trans_date)

        
    
    
# try:
#    corporation_digitization(r"/Users/hardikbhardwaj/Downloads/Statements/01-10-2019 to 31-12-2019.pdf",
#                             r"/Users/hardikbhardwaj/Downloads/Statements/01-10-2019 to 31-12-2019.pdf")
# except:
